...
do
  ...
  -- 'pastely' is a local colorscheme (see colors/pastely.lua) ported from the
  -- VS Code "pastely" theme. Swap the name below to use a different one.
  vim.cmd.colorscheme 'pastely'
